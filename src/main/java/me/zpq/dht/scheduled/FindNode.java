    ...
    public void run() {
        ...
        try {
            ...
            if (size < minNodes) {
                ...
                findNodeQuery = DhtProtocol.findNodeQuery(transactionId, nodeId, Utils.nodeId());
                ...
                findNodeQuery = DhtProtocol.findNodeQuery(transactionId, nodeId, Utils.nearNodeId(nodeId));
